package com.lianlianpay.openapi.client;
...
public class LLianPayClient {
    ...
    public String sendRequest(String url, String body) {
        ...
        return sendRequest(url, body, LLianPayMultiPaymentSignature.getInstance().sign(body));
    }
    ...
    public String sendRequest(String url, String body, String sign) {
        ...
        post.setHeader("mch_id", LLianPayConstant.MCHID);
        ...
        try {
            ...
            if (ret == HttpStatus.SC_OK) {
                ...
                if (!"".equalsIgnoreCase(resSignatureData)) {
                    ...
                    boolean checksign = LLianPayMultiPaymentSignature.getInstance().checkSign(responseString.toString(), resSignatureData);
                    if (!checksign) {
